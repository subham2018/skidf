                ...
                ?>
	              ...
	              <a href="add_guest.php"  style="width:260px;" class="btn btn-glow btn-bg-gradient-x-purple-red col-6 col-md-5 mr-1 mb-1"> Add Guest</a>
	                ...
	                <table class="table table-striped table-bordered sourced-data">
					        ...
					        <tbody>
							<?php
                                $select=mysqli_query($link,"SELECT * FROM ".$prefix."guest");
                               while($row=mysqli_fetch_object($select)){
                                ?>
					            <tr>
					               <td class="center">SI/
					               	<?php if($row->registration_type=="Online")
					               	{
					               		echo "ONLINE";
					               	}
					               	else {
					               ...
					               <td class="center"><?=$row->name?></td>
												...
												<td class="center"><?=$row->registration_type?></td>
												
												<td class="center">
													<a class="btn btn-primary round btn-min-width mr-1 mb-1" href="bookings.php?guest_id=<?=$row->id?>">Bookings</a>
