      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">ADD MASTER LOAN CATEGORY </h3>
          </div>
...
<div class="col-md-6">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-round-controls">Master Loan Category</h4>
		...
		<?php
                    ...
                    if(!empty($_FILES['side_img']['tmp_name']) && is_uploaded_file( $_FILES['side_img']['tmp_name'] )){
                        ...
                        mysqli_query($link,"INSERT INTO ".$prefix."m_loan_category SET ".$query);
...
?>
				...
				<form class="form" method="post" enctype="multipart/form-data">
                  ...
                  <input type="text" id="complaintinput1" class="form-control round" placeholder="Enter Master Loan Category" name="category_name">
                  </div>

                  <div class="form-group">
                  <label for="complaintinput1">Quick Content</label>
                 <input type="text" id="complaintinput1" class="form-control round" placeholder="Enter Quick Content" name="quickcontent">
                  </div>
                  ...
                  <div class="form-group">
                 <textarea name="content" rows="4" cols="50"  placeholder="Describe here..."></textarea>
                </div>
