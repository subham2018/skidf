            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="payment.php?booking_id=<?=$_REQUEST['booking_id']?>&payment=<?=$_REQUEST['payment']?>">Payment</a>
                  </li>
...
<div class="col-md-6">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-round-controls">PAYMENT FOR BOOKING ID: SIB/2019/00<?=$_REQUEST['booking_id']?></h4>
...
$select2=mysqli_query($link,"SELECT * FROM ".$prefix."payment 
...
if($due1>=$_REQUEST['paidvalue'])
{
                    ...
                    $query = substr($query, 0, -1);//omit last comma
                     ...
                     mysqli_query($link,"INSERT INTO ".$prefix."payment SET ".$query);//insert all text info
 ...
 echo '<p class="alert alert-danger" id="success-alert"><i class="fa fa-close fa-fw"></i> Be careful with your paid amount entry!</p>';
                    ...
                    $select1=mysqli_query($link,"SELECT * FROM ".$prefix."payment 
	WHERE `booking_id`=".$_REQUEST['booking_id']);
$i=0;
...
?>
						...
						<form class="form" method="post" enctype="multipart/form-data">
							<div class="form-body">
								<?php
                                $select=mysqli_query($link,"SELECT * FROM ".$prefix."booking WHERE `guest_id`=".$_REQUEST['guest_id']);
