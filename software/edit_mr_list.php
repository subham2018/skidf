      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">EDIT MEDICAL REPRESENTATIVE LIST</h3>
          </div>
            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Update Medical Representative List
                  </li>
                </ol>
              </div>
            </div>
...
<div class="col-md-6">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-round-controls">EDIT MEDICAL REPRESENTATIVE LIST</h4>
				...
				<div class="card-content collapse show">
                    ...
                    $query = substr($query, 0, -1);//omit last comma
                     ...
                     mysql_query("UPDATE ".$prefix."mr SET ".$query." WHERE id=".$_POST['bid']);//insert all text info
...
?>
						...
						<?php
                                $select=mysql_query("SELECT * FROM ".$prefix."mr WHERE `id`=".$_REQUEST['mr_id']);
                        ...
                        <input type="hidden" value="<?=$row->id?>" name="bid" required>
							<div class="form-body">
								...
								<div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" placeholder="Enter MR Name" name="mr_name" value="<?=$row->mr_name?>">
								</div>
                       ...
                       <?php } ?>
								...
								<div class="form-group">
									...
									<input type="email" id="complaintinput2" class="form-control round" name="mr_email" placeholder="Enter MR Email Address" value="<?=$row->mr_email?>">
								</div>
								<div class="form-group">
								
									<label for="complaintinput2">MR PHONE NO</label>
									<input type="number" id="complaintinput2" class="form-control round" name="mr_phone" placeholder="Enter MR Phone No" value="<?=$row->mr_phone?>">
								</div>
								
								<div class="form-group">
									<label for="complaintinput2">MR AADHAR NO</label>
									<input type="text" id="complaintinput2" class="form-control round" placeholder="Enter AADHAR No" name="mr_addhar" value="<?=$row->mr_addhar?>" >
								</div>
							...
							<div class="form-actions">
								...
								<button type="submit" name="usubmit" class="btn btn-primary">
									<i class="ft-user-check"></i>UPDATE MR
								</button>
							</div>
						</form>
					</div>
