	    ...
	    <div class="col-12">
	        <div class="card">
                ...
                ?>
	               ...
	               <a href="add_about.php"  style="width:260px;" class="btn btn-glow btn-bg-gradient-x-purple-red col-6 col-md-5 mr-1 mb-1">Add About Us Content</a>
	                ...
	                <table class="table table-striped table-bordered sourced-data">
					        ...
					        <tbody>
							<?php
                                $select=mysqli_query($link,"SELECT * FROM ".$prefix."about");
                               while($row=mysqli_fetch_object($select)){
					            ...
					            <tr>
					               ...
					               <td><img src="<?=UPLOAD_IMG_PATH.anything('about','side_img',$row->id)?>" height="50px"></td>
