	    ...
	    <div class="col-12">
	        <div class="card">
	            ...
	            <div class="card-content collpase show">
                    ...
                    mysql_query("UPDATE ".$prefix."user SET `status`='".$_REQUEST['status']."' WHERE `id`=".$_REQUEST['id']);
					//update info
                ...
                ?>
	                ...
	                <table class="table table-striped table-bordered sourced-data">
					        ...
					        <tbody>
							<?php
                                $select=mysql_query("SELECT * FROM ".$prefix."user WHERE type='Traveller'");
                               while($row=mysql_fetch_object($select)){
					            ...
					            <tr>
					               <td class="center"><?=$row->name?></td>
												...
												<td class="center">
													<?php if ($row->status=='1'){ ?>
													<a class="btn btn-danger" href="?id=<?=$row->id?>&status=0">
														BLOCK
													</a>
													<?php } else {?>
													<a class="btn btn-primary" href="?id=<?=$row->id?>&status=1">
														ACTIVATE
													</a>
													<?php } ?>
												</td>
