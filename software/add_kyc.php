      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">ADD GUEST KYC</h3>
          </div>
            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Kyc Add
                  </li>
                </ol>
              </div>
            </div>
...
<div class="col-md-6">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-round-controls">ADD KYC of <?=anything('guest', 'name', $_REQUEST['kyc_id'])?></h4>
                ...
                if(isset($_POST['submit'])){
                    ...
                    if(!empty($_FILES['side_img']['tmp_name']) && is_uploaded_file( $_FILES['side_img']['tmp_name'] )){
                        ...
                        if($image_res != false && resize_image($image_res, $target_file, $image_type, 768, $image_width, $image_height,  $_POST['qa'], true, false)){
                            ...
                            mysqli_query($link,"INSERT INTO ".$prefix."guest_kyc SET ".$query);
                            echo '<p class="alert alert-success" id="success-alert"><i class="fa fa-check fa-fw"></i> Kyc successfully added.</p>';
...
?>
              ...
              <input type="hidden" name="mem_id" value="<?=$_REQUEST['kyc_id']?>">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="complaintinput1" class="form-control round" placeholder="Enter ID no" name="idno">
                </div>

								
								
							<div class="card-header">
                    <label class="card-title" for="exampleInputFile">Scan Copy</label>
                </div>
