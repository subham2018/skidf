      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">Popup Settings</h3>
          </div>
	    ...
	    <div class="col-12">
	        <div class="card">
                ...
                ?>
	               ...
	               <a href="add_popup.php"  style="width:260px;" class="btn btn-glow btn-bg-gradient-x-purple-red col-6 col-md-5 mr-1 mb-1">Add Popup Details</a>
	                ...
	                <table class="table table-striped table-bordered sourced-data">
					        ...
					        <tbody>
							<?php
                                $select=mysqli_query($link,"SELECT * FROM ".$prefix."popup");
                               while($row=mysqli_fetch_object($select)){
					            ...
					            <tr>
					                ...
					                <td><?=$row->des?></td>
					               <td><img src="<?=UPLOAD_IMG_PATH.anything('popup','side_img',$row->id)?>" height="50px"></td>
									
									<td><a class="btn btn-outline-primary round btn-min-width mr-1 mb-1"href="edit_popup.php?popup_id=<?=$row->id?>">Edit</a>
