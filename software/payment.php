      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">Payment for <?=anything('guest','name',$_REQUEST['guest_id'])?></h3>
          </div>
            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="bookings.php?guest_id=<?=anything('booking','guest_id',$_REQUEST['booking_id'])?>">Manage Bookings</a>
                  </li>
	    ...
	    <div class="col-12">
	        <div class="card">
                ...
                ?>
	              ...
	              <a href="add_payment.php?booking_id=<?=$_REQUEST['booking_id']?>&payment=<?=$_REQUEST['payment']?>"  style="width:260px;" class="btn btn-glow btn-bg-gradient-x-purple-red col-6 col-md-5 mr-1 mb-1">Add Payment</a>
	                ...
	                <table class="table table-striped table-bordered sourced-data">
							...
							<?php
                                ...
                                $select1=mysqli_query($link,"SELECT * FROM ".$prefix."payment WHERE `booking_id`=".$_REQUEST['booking_id']);
