      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">ADD POPUP DETAILS</h3>
          </div>
            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="banner.php">POPUP</a>
                  </li>
                  <li class="breadcrumb-item active">POPUP SETTINGS
                  </li>
                </ol>
              </div>
            </div>
...
<div class="col-md-6">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-round-controls">ADD POPUP DETAILS</h4>
                ...
                if(isset($_POST['submit'])){
                    ...
                    if(!empty($_FILES['side_img']['tmp_name']) && is_uploaded_file( $_FILES['side_img']['tmp_name'] )){
                        ...
                        if($image_res != false && resize_image($image_res, $target_file, $image_type, 768, $image_width, $image_height,  $_POST['qa'], true, false)){
                            ...
                            mysqli_query($link,"INSERT INTO ".$prefix."popup SET ".$query);
...
?>
						...
						<form class="form" method="post" enctype="multipart/form-data">
							<div class="form-body">
								...
								<div class="form-group">
									...
									<input type="text" id="complaintinput2" class="form-control round" placeholder="Enter Short Description" name="subtitle">
								</div>
                <div class="form-group">
                  <label for="complaintinput2">Description</label>
                  <input type="text" id="complaintinput2" class="form-control round" placeholder="Enter Short Description" name="des">
                </div>
                ...
                <div class="form-group">
							...
							<div class="form-actions">
								<a href="popup.php" type="button" class="btn btn-danger mr-1" >
