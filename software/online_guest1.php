                ...
                ?>
	             ...
	             <!-- <a href="add_guest.php"  style="width:260px;" class="btn btn-glow btn-bg-gradient-x-purple-red col-6 col-md-5 mr-1 mb-1"> Add Guest</a>-->
	                ...
	                <table class="table table-striped table-bordered sourced-data">
					        ...
					        <tbody>
							<?php
                                $select=mysqli_query($link,"SELECT * FROM ".$prefix."guest WHERE `registration_type`='Online'");
                               while($row=mysqli_fetch_object($select)){
                                ?>
					            <tr>
					               <td class="center">SI/
					               	
					               	ONLINE/<?=date('Y');?>/<?=$row->id?></td>
					          <td class="center"><?=$row->name?></td>
												...
												<td class="center">
													<!-- <a class="btn btn-primary round btn-min-width mr-1 mb-1" href="onlinebookings.php?guest_id=<?=$row->id?>&booking_id=<?=$row->id?>">Bookings</a> -->
												<a class="btn btn-warning round btn-min-width mr-1 mb-1" href="kyc.php?kyc_id=<?=$row->id?>">
														KYC
													</a>
