      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">EDIT CATEGORY LIST</h3>
          </div>
...
<div class="col-md-6">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-round-controls">UPDATE CATEGORY LIST</h4>
				...
				<div class="card-content collapse show">
                    ...
                    $query = substr($query, 0, -1);//omit last comma
                     ...
                     mysqli_query($link,"UPDATE ".$prefix."category SET ".$query." WHERE id=".$_POST['bid']);//insert all text info
...
?>
						...
						<form class="form" method="post" enctype="multipart/form-data">
							<div class="form-body">
							<?php
                                $select=mysqli_query($link,"SELECT * FROM ".$prefix."category WHERE `id`=".$_REQUEST['cat_id']);
                   ...
                   <input type="hidden" value="<?=$row->id?>" name="bid" required>  
								...
								<div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" placeholder="Enter Title1" name="title" value="<?=$row->title?>">
								</div>
							...
							<div class="form-actions">
								<a href="category.php" class="btn btn-danger mr-1" >
