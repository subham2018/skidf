      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">Guest Kyc</h3>
          </div>
            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="guest.php">Guest</a> 
                  </li>
                  <li class="breadcrumb-item active">Guest Kyc
                  </li>
                </ol>
              </div>
            </div>
	    ...
	    <div class="col-12">
	        <div class="card">
	            <div class="card-header">
	                <h4 class="card-title">Guest KYC of <?=anything('guest', 'name', $_REQUEST['kyc_id'])?></h4>
	            ...
	            <div class="card-content collpase show">
                    ...
                    if(mysqli_query($link,"DELETE FROM ".$prefix."guest_kyc WHERE id=".variable_check($_GET['del']))){ //delete info
                ...
                ?>
	               ...
	               <a href="add_kyc.php?kyc_id=<?=$_REQUEST['kyc_id']?>"  style="width:260px;" class="btn btn-glow btn-bg-gradient-x-purple-red col-6 col-md-5 mr-1 mb-1">ADD NEW</a>
	                ...
	                <table class="table table-striped table-bordered sourced-data">
					        ...
					        <tbody>
							<?php
                         $select=mysqli_query($link,"SELECT * FROM ".$prefix."guest_kyc WHERE `mem_id`=".$_REQUEST['kyc_id']);
                               while($row=mysqli_fetch_object($select)){
                                ?>
					            <tr>
					                <td><?=$row->title?></td>
					                <td><img src="<?=UPLOAD_IMG_PATH.$row->side_img?>" width="50px;"></td>
					         
									<td><a class="btn btn-outline-primary round btn-min-width mr-1 mb-1"href="edit_kyc.php?kyc_id=<?=$row->id?>">Edit</a>
