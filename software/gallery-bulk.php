      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title"><?=anything('homestays','name',$_REQUEST['img'])?> GALLERY IMAGES</h3>
          </div>
            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="rooms.php">Room Type</a>
                  </li>
                  <li class="breadcrumb-item"><a href="room_listing.php?room_id=<?=$_REQUEST['id']?>">List Rooms</a>
                  </li>
...
<div class="col-md-6">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-round-controls">ADD <?=anything('homestays','name',$_REQUEST['img'])?> GALLERY IMAGES</h4>
					...
					foreach($_FILES['image']['tmp_name'] as $key => $tmp_name ){
						...
						if(!empty($_FILES['image']['tmp_name'][$key]) && is_uploaded_file( $_FILES['image']['tmp_name'][$key] )){
					        ...
					        if($image_res != false && resize_image($image_res, $target_file, $image_type, 1366, $image_width, $image_height, 80, false, true)){
					            ...
					            mysqli_query($link,"INSERT INTO `".$prefix."room_listing_gallery` SET
			   ...
			   //delete Projects
                    ...
                    if(mysql_query("DELETE FROM ".$prefix."gallery WHERE id=".variable_check($_GET['del']))){ //delete info
						...
						<form class="form" method="post" enctype="multipart/form-data">
							<div class="form-body">
								...
								<div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" placeholder="Enter Property Name" name="title">
								</div>
								<div class="form-group">
							...
							<div class="form-actions">
								<a href="room_listing.php?room_id=<?=$_REQUEST['id']?>" type="button" class="btn btn-danger mr-1" >
...
<div class="panel panel-default">
                ...
                <div class="row">
				   ...
				   <?php
					$select = mysql_query("SELECT * FROM ".$prefix."gallery WHERE homestay_id=".$_REQUEST['img']." ORDER BY `id` DESC");
