      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">Medical Representative</h3>
          </div>
            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Medical Representative
                  </li>
                </ol>
              </div>
            </div>
	    ...
	    <div class="col-12">
	        <div class="card">
	            <div class="card-header">
	                <h4 class="card-title">Medical Representative List</h4>
	            ...
	            <div class="card-content collpase show">
                    ...
                    if(mysql_query("DELETE FROM ".$prefix."mr WHERE id=".variable_check($_GET['del']))){ //delete info
                ...
                ?>
	               ...
	               <a href="add_mr_list.php"  style="width:260px;" class="btn btn-glow btn-bg-gradient-x-purple-red col-6 col-md-5 mr-1 mb-1">Click Here To Add MR</a>
	                ...
	                <table class="table table-striped table-bordered sourced-data">
					        ...
					        <tbody>
							<?php
                                $select=mysql_query("SELECT * FROM ".$prefix."mr");
					    ...
					    <td class="center"><?=anything('area','name',$row->area_id)?></td>
									...
									<td><a class="btn btn-outline-primary round btn-min-width mr-1 mb-1"href="edit_mr_list.php?mr_id=<?=$row->id?>">Edit</a>
