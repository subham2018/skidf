	    ...
	    <div class="col-12">
	        <div class="card">
	            ...
	            <div class="card-content collpase show">
                    ...
                    if(mysql_query("DELETE FROM ".$prefix."service WHERE id=".variable_check($_GET['del']))){ //delete info
                ...
                ?>
	               ...
	               <a href="add_service.php"  style="width:260px;" class="btn btn-glow btn-bg-gradient-x-purple-red col-6 col-md-5 mr-1 mb-1">Click Here To Add New Service</a>
	                ...
	                <table class="table table-striped table-bordered sourced-data">
					        ...
					        <tbody>
							<?php
                                $select=mysql_query("SELECT * FROM ".$prefix."service");
                               while($row=mysql_fetch_object($select)){
                                ?>
					            <tr>
					                <td><?=$row->title?></td>
					                <td><?=anything('category', 'title', $row->cat_id)?></td>
									<td class="center"><img src="<?=UPLOAD_IMG_PATH . $row->image?>" alt="NA" height="80"></td>	         
									<td><a class="btn btn-outline-primary round btn-min-width mr-1 mb-1"href="edit_property.php?property_id=<?=$row->id?>">Edit</a>
