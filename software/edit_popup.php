      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">EDIT POPUP</h3>
          </div>
            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="banner.php">POPUP SETTINGS</a>
                  </li>
                  <li class="breadcrumb-item active">Edit POPUP
                  </li>
                </ol>
              </div>
            </div>
...
<div class="col-md-6">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-round-controls">UPDATE POPUP</h4>
   ...
   if(isset($_POST['usubmit'])){
                    ...
                    if(!empty($_FILES['side_img']['tmp_name']) && is_uploaded_file( $_FILES['side_img']['tmp_name'] )){
                        ...
                        if($image_res != false && resize_image($image_res, $target_file, $image_type, 768, $image_width, $image_height,  $_POST['qa'], true, false)){
                            ...
                            unlink(UPLOAD_IMG_PATH . anything('popup','side_img',$_POST['bid']));
                            mysqli_query($link,"UPDATE ".$prefix."popup SET `side_img`='".$fbasename."' WHERE `id`=".$_POST['bid']);
                        }
                        else {
                            unlink($target_file);
                            $error='1';
                    ...
                    if(!isset($error) && mysqli_query($link,"UPDATE ".$prefix."popup SET ".$query." WHERE id=".$_POST['bid'])) //insert all text info
...
?>
						...
						<form class="form" method="post" enctype="multipart/form-data">
							<div class="form-body">
							<?php
               $select=mysqli_query($link,"SELECT * FROM `".$prefix."popup` WHERE `id`=".$_REQUEST['popup_id']);
                ...
                <div class="form-group">
                  <label for="complaintinput2">Sub Title</label>
                  <input type="text" id="complaintinput2" class="form-control round" placeholder="Enter Short Description" name="subtitle" value="<?=$row->subtitle?>">
                </div>
                <div class="form-group">
                  <label for="complaintinput2">Description</label>
                  <input type="text" id="complaintinput2" class="form-control round" placeholder="Enter Short Description" name="des" value="<?=$row->des?>">
                </div>

							
								<div class="card-header">
                    <label class="card-title" for="exampleInputFile">Popup Image</label>
                </div>
            ...
            <div class="form-group">
							...
							<div class="form-actions">
								<a href="popup.php" class="btn btn-danger mr-1" >
