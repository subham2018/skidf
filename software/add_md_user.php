...
<title><?=$site->site_title?> | ADMIN PANEL | MASTER DISTRIBUTORS REGISTRATION</title>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">ADD MASTER DISTRIBUTORS </h3>
          </div>
            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="#">Master Distributors Users</a>
                  </li>
...
<div class="col-md-6">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-round-controls">M Distributors Registration Form</h4>
            ...
            $resultset_1 = mysqli_query($link,"select * from ".$prefix."dsa_user where token='".$first_name."' ") or die(mysqli_error());
                     $count = mysqli_num_rows($resultset_1);
                 if($count == 1)
                  {
                        mysqli_query($link,"INSERT INTO ".$prefix."md_user SET ".$query);
       ...
       // $to = $_POST['email'];
        ...
        //             $subject = "Master Distributor Registration Confirmation";
        ...
        //              mail($to1, $subject, $message, $headers);
                          ...
                          echo '<p class="alert alert-danger" id="danger-alert"><i class="fa fa-times-circle fa-fw"></i>Reference no is Not Present</p>' ;
                        }}}}
...
?>
                ...
                <div class="form-group">
                  <label for="complaintinput1">DSA Reference No</label>
                  <input type="text" id="complaintinput1" class="form-control round" placeholder="Enter DSA Reference No" name="reference_no">
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" id="complaintinput2" class="form-control round" placeholder="Enter Aadhar Card No" name="pancard">
                  </div>
                    ...
                    <input type="text" id="complaintinput2" class="form-control round" placeholder="Enter Account Holder Name" name="ac_holder_name">
								...
								<h4>Master Distributor Image</h4>
                ...
                <div class="form-group">
							...
							<div class="form-actions">
								<a href="md.php" type="button" class="btn btn-danger mr-1" >
