	    ...
	    <div class="col-12">
	        <div class="card">
	            ...
	            <div class="card-content collpase show">
                    ...
                    if(mysql_query("DELETE FROM ".$prefix."homestays WHERE id=".variable_check($_GET['del']))){ //delete info
                ...
                ?>
	               ...
	               <a href="add_homestay.php"  style="width:260px;" class="btn btn-glow btn-bg-gradient-x-purple-red col-6 col-md-5 mr-1 mb-1">Click Here To Add New Property</a>
	                ...
	                <table class="table table-striped table-bordered sourced-data">
					        ...
					        <tbody>
							<?php
                                $select=mysql_query("SELECT * FROM ".$prefix."homestays");
                               while($row=mysql_fetch_object($select)){
                                ?>
					            <tr>
					            	<td><?=$row->name?></td>
					               <td><?=anything('property_type', 'property_type', $row->property_type)?></td>
					                <td><?=$row->payment?></td>
					                <td><?=anything('user', 'name', $row->ven_id)?></td>
					                <td style="padding-left:95px;"><a href="property-bulk.php?img=<?=$row->id?>" class="btn btn-danger">Bulk Images</a></td>
					         
									<td><a class="btn btn-outline-primary round btn-min-width mr-1 mb-1"href="#">Edit</a>
