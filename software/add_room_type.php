      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">ADD ROOM TYPE</h3>
          </div>
            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Room Type
                  </li>
                </ol>
              </div>
            </div>
...
<div class="col-md-6">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-round-controls">ADD ROOM TYPE</h4>
                ...
                if(isset($_POST['submit'])){
                    ...
                    if(!empty($_FILES['side_img']['tmp_name']) && is_uploaded_file( $_FILES['side_img']['tmp_name'] )){
                        ...
                        if($image_res != false && resize_image($image_res, $target_file, $image_type, 768, $image_width, $image_height,  $_POST['qa'], true, false)){
                            ...
                            mysqli_query($link,"INSERT INTO ".$prefix."room_type SET ".$query);
                            echo '<p class="alert alert-success" id="success-alert"><i class="fa fa-check fa-fw"></i> Room Type successfully added.</p>';
                        }
                        else {
                            unlink($target_file);
						...
						<form class="form" method="post" enctype="multipart/form-data">
							<div class="form-body">
								...
								<div class="form-group">
									...
									<input type="text" id="complaintinput1" class="form-control round" placeholder="Enter Property Type" name="room_type">
								</div>
							</div>
							<div class="form-body">
								...
								<textarea name="description" rows="4" cols="50" id="editor" placeholder="Describe yourself here..."></textarea>
								</div>
							</div>
							<div class="form-body">

								<div class="form-group">
									<label for="complaintinput1">Start Price</label>
									<input type="number" id="complaintinput1" class="form-control round" placeholder="Enter Property Type" name="startprice">
								</div>
							</div>
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="complaintinput1" class="form-control round" placeholder="Enter Property Type" name="adult">
                                </div>
                            </div>
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="complaintinput1" class="form-control round" placeholder="Enter Property Type" name="child">
                                </div>
                            </div>
							<div class="card-header">
