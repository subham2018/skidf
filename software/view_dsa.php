      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">VIEW UPDATE DSA DETAILS</h3>
          </div>
            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="dsa.php">DSA Users</a>
                  </li>
                  <li class="breadcrumb-item active">View / Update DSA Details
                  </li>
                </ol>
              </div>
            </div>
...
<div class="col-md-6">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-round-controls">DSA Details</h4>
                   ...
                   if(isset($_POST['usubmit'])){
                    ...
                    if(!empty($_FILES['side_img']['tmp_name']) && is_uploaded_file( $_FILES['side_img']['tmp_name'] )){
                        ...
                        if($image_res != false && resize_image($image_res, $target_file, $image_type, 768, $image_width, $image_height,  $_POST['qa'], true, false)){
                            ...
                            unlink(UPLOAD_IMG_PATH . anything('dsa_user','side_img',$_REQUEST['id']));
                            mysqli_query($link,"UPDATE ".$prefix."dsa_user SET `side_img`='".$fbasename."' WHERE `id`=".$_REQUEST['id']);
                        }
                        else {
                            unlink($target_file);
                            $error='1';
                    ...
                    if(!isset($error) && mysqli_query($link,"UPDATE ".$prefix."dsa_user SET ".$query." WHERE id=".$_REQUEST['id'])) //insert all text info
                        echo '<p class="alert alert-success" id="success-alert"><i class="fa fa-check fa-fw"></i> DSA information successfully updated.</p>';
                    else { 
...
?>
						...
						<form class="form" method="post" enctype="multipart/form-data" name="RegForm" onsubmit="formvalidate()">
							<div class="form-body">
							<?php
                                $select=mysqli_query($link,"SELECT * FROM ".$prefix."dsa_user WHERE `id`=".$_REQUEST['id']);
