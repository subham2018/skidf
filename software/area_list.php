	    ...
	    <div class="col-12">
	        <div class="card">
	            ...
	            <div class="card-content collpase show">
                    ...
                    if(mysql_query("DELETE FROM ".$prefix."area WHERE id=".variable_check($_GET['del']))){ //delete info
                ...
                ?>
	               ...
	               <a href="add_area_list.php"  style="width:260px;" class="btn btn-glow btn-bg-gradient-x-purple-red col-6 col-md-5 mr-1 mb-1">Click Here To Add New Area</a>
							...
							<?php
                               ...
                               while($row=mysql_fetch_object($select)){
					            ...
					            <tr>
									...
									<td><a class="btn btn-outline-primary round btn-min-width mr-1 mb-1"href="edit_area_list.php?area_id=<?=$row->id?>">Edit</a>
